...
function AgendaStats({
  ...
  const stats = [
    { label: 'Aulas na Semana', value: totalAulas, icon: Calendar, className: '' },
    { label: 'Presencas', value: presencas, icon: Check, className: 'text-green-600' },
    { label: 'Faltas', value: faltas, icon: X, className: 'text-red-600' },
    { label: 'Pendentes', value: pendentes, icon: Clock, className: 'text-blue-600' },
  ]
